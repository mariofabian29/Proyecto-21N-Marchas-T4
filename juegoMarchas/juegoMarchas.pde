...
if (boton12Avanzar == 0)
    ...
    if (unaVez == false)
    {
      if (boton6==1  && boton2==1 && boton4==1 && boton9==1 && boton7==1)
      {
        estado = 6; 
        unaVez = true;
      }
...
if (unaVez == false)
    {
      if (boton2==1  && boton8==1 && boton4==1 && boton10==1 && boton12Avanzar==1)
      {
        estado =9; 
        unaVez = true;
      }
...
if (unaVez == false)
    {
      if (boton2==1  && boton5==1
      && boton4==1 && boton9==1 
      && boton8==1 && boton12Avanzar==1
      && boton7==1&& boton6==1)
      {
        estado =12; 
        unaVez = true;
